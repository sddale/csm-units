...
constexpr auto kg = Literal<Exponents<0, 1, 0, 0, 0, 0, 0>>();
...
constexpr auto Pa2 = Literal<Exponents<-2, 2, -4, 0, 0, 0, 0>>();
constexpr auto Pa3 = Literal<Exponents<-3, 3, -6, 0, 0, 0, 0>>();
constexpr auto Pa4 = Literal<Exponents<-4, 4, -8, 0, 0, 0, 0>>();
